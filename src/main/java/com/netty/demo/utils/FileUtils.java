...
public class FileUtils {
	 ...
	 * @return
	 */
	public static MultipartFile base64ToMultipart(String subfix,String base64Data){
		String dataPrix = "";
		String data = "";
		...
		MockMultipartFile multipartfile = new MockMultipartFile(UUID.randomUUID().toString().replaceAll("\\-", "") + subfix, "png", "image/png", bs);
		return multipartfile;
	}

	/**
	 * byte数组转mutilpartfile
	 * @param subfix
	 * @param bytes
	 * @return
	 */
	public static MultipartFile bytesToMultiPart(String subfix,byte[] bytes){
		return new MockMultipartFile(UUID.randomUUID().toString().replaceAll("\\-", "") + subfix, "png", "image/png", bytes);
	}
